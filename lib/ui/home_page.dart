...
import 'package:musicapp_credixcotask/bloc/Track_bloc.dart';
import 'package:musicapp_credixcotask/bloc/Track_event.dart';
import 'package:musicapp_credixcotask/bloc/Track_state.dart';
import 'package:musicapp_credixcotask/model/Track_model.dart';
import 'package:musicapp_credixcotask/repo/Track_repo.dart';
import 'package:musicapp_credixcotask/ui/track_details.dart';
              ...
              onPressed: () {
                ...
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (_) => BlocProvider(
                          create: (context) =>
                              FavTrack_Bloc(repository: TrackRepositoryImpl()),
                          child: Fav_Page(),
                        )));
              },
            ),
                ...
                Navigator.of(context).push(MaterialPageRoute<Track_Details>(
                    builder: (_) => BlocProvider(
                          create: (context) => ParticularTrack_Bloc(
                              ...
                              Trackid: tracks[pos].id.toString()),
                          child: Track_Details(tracks[pos].id.toString()),
                        )));
              },
              child: Row(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        tracks[pos].track_name.toString(),
                        style: TextStyle(fontSize: 14, color: Colors.black),
                      ),
                      Text(
                        tracks[pos].artist_name.toString(),
                  ...
                  Container(
                      height: 50,
                      width: 75,
                      child: Text(tracks[pos].album_name.toString(),
