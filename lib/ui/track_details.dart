                    ...
                    builder: (context, state) {
                      if (state is TrackInitialState) {
                        ...
                        currentTrack = SavedTrack(
                            ...
                            artist_name: state.track.artist_name,
                            album_name: state.track.album_name,
                            track_rating: state.track.track_rating,
                            explicit: state.track.explicit);
                        return Padding(
